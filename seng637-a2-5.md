...
| TC2     | 3.0        | Inside Range       | EC2        | Testing a value inside the valid range (between 1.0 and 5.0)             | True           | Pass        |
| TC3     | 1.0        | Lower Boundary     | EC2        | Testing the lower boundary value of the range (1.0)                      | True           | Pass        |
| TC4     | 5.0        | Upper Boundary     | EC2        | Testing the upper boundary value of the range (5.0)                      | True           | Pass        |
| TC5     | 6.0        | Above Upper Bound  | EC3        | Testing value just above the upper boundary of the range (5.0)           | False          | Pass        |
