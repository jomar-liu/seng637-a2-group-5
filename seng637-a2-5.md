...
Testing value just below the lower boundary of the range (1.0) 
...
Testing the lower boundary value of the range (1.0) 
...
Testing the upper boundary value of the range (5.0) 
...
Testing value just above the upper boundary of the range (5.0) 
