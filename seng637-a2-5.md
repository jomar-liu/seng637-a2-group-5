...
| TC6     | 5.0        | 1.0       | EC3           | Reverse boundaries; central value should still be the average              <br>Method:testGetCentralValueReverseRange        | Exception             | Pass (Exception Expected) |
...
|---------|------------|-----------|---------------|------------------------------------------------------------------------------|---------------------|-------------|
| TC1     | 1.0        | 5.0       | EC1           | Standard range with the upper bound clearly defined  <br>Method: testUpperBoundShouldBeOne                       | 5.0                 | Fail        |
...
| TC5     | 5.0        | 1.0       | EC3           | Reverse boundaries (invalid range where lower > upper) <br>Method:testUpperBoundReverseRange                      | Exception           | Pass (Exception Expected) |
...
|---------|------------|-----------|---------------|-----------------------------------------------------------|---------------------|-------------|
| TC1     | 1.0        | 5.0       | EC1           | Standard range with the lower bound clearly defined <br>Method: testLowerBoundShouldBeZero      | 1.0                 | Pass        |
...
| TC5     | 5.0        | 1.0       | EC3           | Reverse boundaries (invalid input: lower > upper)  <br>Method:  testLowerBoundReverseRange     | Exception           | Pass (Exception Expected) |
