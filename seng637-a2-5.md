...
This lab helped greatly to understand JUnit and unit testing procedures, with regard to organization and documentation of each test case's objective. We had to carefully examine each method's intended behaviour in order to write assertions with expected results. 
