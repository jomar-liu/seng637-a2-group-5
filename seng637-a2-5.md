...
|------------------|------------------|-------------------------------------------------------------------------------|
| Zhanzi, Joe | DataUtilitiesTest          |  |
| Kwesi, Lawrence | RangeTest | Reviewing of the Rangeclass in Javadoc, using equivalence classes and boundary values to design black-box tests, implementing JUnit tests to 5 chosen methods, run the tests, and document the results. |
