...
| TC - ID | Input Value | Boundary            | EC Covered | Scenario Description & Method                                                      | Expected Result | Test Outcome |
|---------|------------|--------------------|------------|---------------------------------------------------------------------------|----------------|-------------|
| TC1     | 0.0        | Below Lower Bound  | EC1        | Testing value just below the lower boundary of the range (1.0)  Method: testContainsBelowRange           | False          | Pass        |
| TC2     | 3.0        | Inside Range       | EC2        | Testing a value inside the valid range (between 1.0 and 5.0)  Method: testContainsInsideRange             | True           | Pass        |
| TC3     | 1.0        | Lower Boundary     | EC2        | Testing the lower boundary value of the range (1.0)    Method: testContainsLowerBoundary                   | True           | Pass        |
| TC4     | 5.0        | Upper Boundary     | EC2        | Testing the upper boundary value of the range (5.0)   Method: testContainsUpperBoundary                    | True           | Pass        |
| TC5     | 6.0        | Above Upper Bound  | EC3        | Testing value just above the upper boundary of the range (5.0) Method: testContainsAboveRange           | False          | Pass        |
...
| TC - ID | Range Start | Range End | EC Covered     | Scenario Description & Method                                                   | Expected Length | Test Outcome |
|:--------|:-----------:|:---------:|:---------------|---------------------------------------------------------------------------|:---------------:|:------------:|
| TC1     | 1.0         | 5.0       | EC1            | Standard range with distinct start and end values Method: testGetLength                      | 4.0             | Pass         |
| TC2     | 1.0         | 1.1       | EC1            | Small range with a tiny difference between the start and end Method: testGetLengthSmallRange           | 0.1             | Pass         |
| TC3     | 1.0         | 1000000.0 | EC1, EC5       | Large range with a large difference between the start and end  Method: testGetLengthLargeRange         | 999999.0        | Pass         |
| TC4     | 5.0         | 5.0       | EC2            | Zero-length range (same start and end)    Method: testGetLengthZeroRange                 | 0.0             | Pass         |
| TC5     | -5.0        | 5.0       | EC1, EC4       | Range spanning both negative and positive values   Method: testGetLengthNegativeToPositive                       | 10.0            | Pass         |
